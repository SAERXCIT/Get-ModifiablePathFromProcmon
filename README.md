...
A simple PowerShell function parsing a [Procmon](https://docs.microsoft.com/en-us/sysinternals/downloads/procmon) CSV output to extract accessed filesystem and registry paths and using @itm4n's [PrivescCheck](https://github.com/itm4n/PrivescCheck/)'s functions `Get-ModifiablePath` and `Get-ObjectAccessRight` to find paths modifiable by the user.
